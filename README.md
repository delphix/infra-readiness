...
No knowledge of Python is required. In fact, no programming experience whatsoever is required to use these scripts. Theare scripts which gather the ESX & VM settings of the Delphix engine and also run automated 
network tests.
